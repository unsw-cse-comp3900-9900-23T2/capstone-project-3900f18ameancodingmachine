 ...
 *  curSubs is a local array which will return the results of
 *  the function
 *  index is an int which will tell the database where to start
 *  returning subscriptions from
 *  count is an int which will tell the database how many subscriptions
 *  from index to return
      ...
      <Card sx={{minWidth: 275}} square>
        <CardContent>
          ...
          <Grid container spacing={2}>
            <Grid container xs={12} spacing={2}>
              ...
              <Grid xs={2}>
                <Button variant="contained" onClick={handleOnClickBrowse}>
                  Browse
                </Button>
              </Grid>
              <Grid xs={2}>
        ...
        <CardActions>
          ...
          {userContext === true && !viewSubscriptions && (
            <Button
              variant="contained"
              onClick={handleOnClickViewSubscriptions}
            >
              View Subscriptions
            </Button>
          )}
 ...
 *
 * @param {*} props
 * @return {JSX} Subscription Grid Item component
 */
