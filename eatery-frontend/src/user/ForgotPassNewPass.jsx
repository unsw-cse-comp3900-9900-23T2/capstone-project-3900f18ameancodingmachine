...
/**
 * This function should send the password
 * reset along with the verification code to
...
/**
 * @return {JSX} Forgot Pass component
 */
    ...
    <Container maxWidth="md">
      ...
      >
        <CardContent>
          ...
          {!isPassStrong && (
            <Typography sx={{fontSize: 14}} color="red" gutterBottom>
              Password length must be atleast 8 with 1 uppercase and lowercase
              character aswell as 1 number and symbol
            </Typography>
          )}
        </CardContent>
        <CardActions>
