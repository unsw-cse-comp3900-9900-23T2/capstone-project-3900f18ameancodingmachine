          ...
          <Grid container spacing={2}>
            ...
            <Grid container xs={12} spacing={2}>
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-first-name" label="First Name" value={firstName} onChange={(event) => {
              ...
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-last-name" label="Last Name" value={lastName} onChange={(event) => {
            ...
            <Grid container xs={12} spacing={2}>
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required type="password" id="register-password" label="Password" value={password} onChange={(event) => {
              ...
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required type="password" id="register-confirm-password" label="Confirm Password" value={confirmPassword} onChange={(event) => {
            ...
            <Grid container xs={12} spacing={2}>
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-street" label="Street" value={street} onChange={(event) => {
              ...
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-suburb" label="Suburb" value={suburb} onChange={(event) => {
            ...
            <Grid container xs={12} spacing={2}>
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-region" label="Region" value={region} onChange={(event) => {
              ...
              <Grid xs={6} spacing={2}>
                ...
                <TextField sx={{bgcolor: "white"}} required id="register-postcode" label="PostCode" value={postCode} onChange={(event) => {
